...
int32_t gpu_mmio_access_handler(struct io_request *io_req, void *handler_private_data)
{
	...
	pr_err("%s, bar0:%lx mmio_addr:%lx offset:%x", __func__, mmio_base, mmio->address, offset);
